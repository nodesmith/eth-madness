    ...
    <div style={{ padding: 12 }}> { /* https://material-ui.com/layout/grid/#negative-margin */}
      ...
      <Grid item {...sizes}>
        ...
        <ol className={classes.ol}>
          ...
          <Typography className={classes.bodyText}>
            That was a bit of a simplification - for all the nitty, gritty details - <a href="https://github.com/nodesmith/eth-madness">check out the code yourself</a>! Everything is open source.  Two things to note: the contract will not allow you to submit the exact same bracket as another person, and in the case of a tie after the final score tiebreaker, the winner will go to the bracket submitted earliest
          </Typography>
