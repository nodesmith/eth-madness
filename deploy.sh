...
IMAGE_NAME=nodesmith/eth-madness:ncaaw-$TRAVIS_COMMIT
...
CMD="kubectl patch deployment eth-madness-womens --context=aws-us-east --kubeconfig=$TRAVIS_BUILD_DIR/kubeconfig -p $PATCH"
eval $CMD
kubectl get pods -l app=eth-madness-womens --kubeconfig $TRAVIS_BUILD_DIR/kubeconfig
